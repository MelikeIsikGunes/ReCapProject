...
namespace Business.Constants
{
    public static class Messages
    {
        ...
        public static string CarGetById = "Araba detay getirildi";
        public static string CarsListed = "Arabalar listelendi";
        public static string CarNameInvalid = "Araba ismi geçersiz";

        public static string BrandAdded = "Marka eklendi";
        public static string BrandDeleted = "Marka slindi";
        public static string BrandUpdated = "Marka güncellendi";
        public static string BrandGetById = "Marka detay getirildi";
        public static string BrandsListed = "Markalar listelendi";
        public static string BrandNameInvalid = "Marka ismi geçersiz";

        public static string ColorAdded = "Renk eklendi";
        public static string ColorDeleted = "Renk slindi";
        public static string ColorUpdated = "Renk güncellendi";
        public static string ColorGetById = "Renk detay getirildi";
        ...
        public static string RentalDeleted = "Araba kiralama listesinden silindi";
        public static string RentalUpdated = "Araba kiralama listesi güncellendi";
